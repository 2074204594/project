...
<html>
	...
	<%@include file="header.jsp" %>
		<div class="all" style="margin-top: 10%;">
			<div class="top" style="height: 40px;width: 500px;background-color: #a3c8ee;margin: auto;line-height: 40px;padding-left: 20px;padding-top: 8px">
			...
			<div style="width: 500px;height: 400px;border: #000000 1px solid;background-color: #EEEEEE;" class="content">
					<div id="carouselExampleFade" class="carousel slide carousel-fade" data-interval="false" data-wrap="false">
					  <div class="carousel-inner" id="wordRecall">
						  <div class="carousel-item">
							  <div style="position: absolute;top: 50px;">
								  发音:
								  <span style="font-size: 15pt;margin-right: 20px;">['rekəɡnaɪz]</span>
							  ...
							  <div style="position: absolute;top: 200px;">
								  ...
								  <span style="color: blue;font-size: 20pt;margin: 20px;display: block;margin-left: 170px;margin-top: 0px;">web</span>
							  </div>
						  </div>
						 </div>
				...
				$.post("/study/getStudyMyWord.do",{"username":username},function (result) {
					...
					for(var bookDetail of result){
						html+="<div class=\"carousel-item\">\n" +
								"<div style=\"position: absolute;top: 50px;display: none\" id='"+bookDetail.english+"word"+"'>\n" +
								"发音:\n" +
								"<span style=\"font-size: 15pt;margin-right: 20px;\">"+bookDetail.symbols+"</span>\n" +
								"<button onclick=\"PlayMP3('"+bookDetail.english+"')\" style='border: 0px'><img src=\"images/play.jpg\" style=\"margin-left: 20px\" ></button>\n" +
								"</div>\n" +
								"<div style=\"margin-top: 25px;margin-left: 25px;position: absolute;top: 60px;left: -24px;\">\n" +
								"释义:<span></span>\n" +
